...
complete_test_with_ID = pd.read_csv("../Cancer/imputed/breast-cancer.shuf.test.imput.csv")
complete_train_with_ID = pd.read_csv("../Cancer/imputed/breast-cancer.shuf.train.imput.csv")
...
complete_test_with_ID.to_csv("../Cancer/imputed/breast-cancer.shuf.test.imput.numerical.csv")
complete_train_with_ID.to_csv("../Cancer/imputed/breast-cancer.shuf.train.imput.numerical.csv")
