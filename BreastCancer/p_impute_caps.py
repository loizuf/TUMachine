...
train_complete_with_ID = pd.read_csv("G:/OrderForLinux/Universitaet/Wien/3.Semester/Machine_Learning/Cancer/cleaning/breast-cancer.shuf.train.complete.csv")
train_missing_caps_with_ID = pd.read_csv("G:/OrderForLinux/Universitaet/Wien/3.Semester/Machine_Learning/Cancer/cleaning/breast-cancer.shuf.train.missing_caps.csv")
...
test_missing_caps_with_ID = pd.read_csv("G:/OrderForLinux/Universitaet/Wien/3.Semester/Machine_Learning/Cancer/cleaning/breast-cancer.shuf.test.missing_caps.csv")
