...
clf = RandomForestClassifier(min_impurity_decrease=0.01, min_samples_leaf=4)
...
dt_results.write("These are the Results of analyzing the Malicious_software-Dataset with the following random Forest:\n\n" + str(clf)
